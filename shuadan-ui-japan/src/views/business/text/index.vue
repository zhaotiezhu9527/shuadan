<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:text:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:text:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="textList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="code代码" align="center" prop="code" />
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        code: [
          { required: true, message: "code代码不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文本管理编号为"' + ids + '"的数据项？').then(function() {
        return delText(ids);
      }).then(() => {
        this.getList();
